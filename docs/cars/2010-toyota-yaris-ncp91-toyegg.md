---
title: "'Toy Egg' a 2010 Toyota Yaris NCP91"
subtitle: NCP91 JDM-faced daily driver build
datePublished: "2026-08-31T12:00:00"
published: true
...
The wheels were the other half of the "buy the parts before the car"
...
BC Racing's BR Type coilovers went in with a soft 5kg/mm front and 3kg/mm
rear spring rate—comfortable enough for daily driving, not stiffened for
anything. A Cusco center lock pillow ball upper mount, fresh camber bolts,
...
Muteki open-end lug nuts,
wheel spacers, front and rear.

## Mechanical & Reliability

This is the section that matters most to the whole philosophy: the Yaris is
an automatic, which forces the build to stay basic by design. No clutch to
think about, no shift points, no decisions. Just get in and drive.

Reliability work has been ordinary and cheap, the way it should be for an
...
Qwik-Latch quick-release hood latches,
routine oil changes.
